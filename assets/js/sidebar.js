...
export function sidebar(){
    ...
    then change genere formate eg:{123:"Action"}
    */
    ...
    sidebarInner.innerHTML=`<div class="sidebar-list">
        ...
        <div class="sidebar-footer">
            <p class="copyright">
                Copyright 2024 <a href="">Kamaljit Behera</a>
            </p>
            <img src="./assets/images/tmdb-logo.svg" width="130" height="17" alt="the movie data base logo">
        </div>`;
